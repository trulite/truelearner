...
fn main() {
    ...
    for (name, path) in [
        ...
        (
            "DS8_GATE_PROTOCOL_V2_SHA256",
            "experiments/ds8_cumulative_semantic_credit_gate_protocol_v2.md",
        ),
        (
            "DS8_GATE_PROTOCOL_V3_SHA256",
            "experiments/ds8_cumulative_semantic_credit_gate_protocol_v3.md",
        ),
        (
            "DS8_DEFINITIVE_M5_ALLOCATOR_SHA256",
            "src/ds7_cumulative_plasticity_targeting_probe.rs",
        ),
        (
            "DS8_DEFINITIVE_M5_CSV_SHA256",
            "results/ds7_cumulative_plasticity_allocation_definitive.csv",
        ),
        (
            "DS8_DEFINITIVE_M5_MD_SHA256",
            "results/ds7_cumulative_plasticity_allocation_definitive.md",
        ),
        (
            "DS8_DEFINITIVE_ACTIVATION_SHA256",
            "experiments/ds8_cumulative_semantic_credit_activation_handoff.md",
        ),
        (
            "DS8_DEFINITIVE_DEPENDENCY_SHA256",
            "experiments/ds8_cumulative_semantic_credit_dependency_audit.md",
        ),
        (
            "DS8_DEFINITIVE_PROBE_PROTOCOL_SHA256",
            "experiments/ds8_cumulative_semantic_credit_probe_protocol.md",
        ),
        (
            "DS8_DEFINITIVE_PROBE_PROTOCOL_V2_SHA256",
            "experiments/ds8_cumulative_semantic_credit_probe_protocol_v2.md",
        ),
        (
            "DS8_DEFINITIVE_PROBE_SOURCE_SHA256",
            "src/ds8_cumulative_semantic_credit_probe.rs",
        ),
        (
            "DS8_DEFINITIVE_PROBE_RUNNER_SHA256",
            "src/bin/ds8_cumulative_semantic_credit_probe.rs",
        ),
        (
            "DS8_DEFINITIVE_PROBE_RESULT_SHA256",
            "results/ds8_cumulative_semantic_credit_probe_v2.md",
        ),
        (
            "DS8_DEFINITIVE_PROBE_AUDIT_SHA256",
            "experiments/ds8_cumulative_semantic_credit_probe_v2_result_audit.md",
        ),
        (
            "DS8_DEFINITIVE_PROBE_HANDOFF_SHA256",
            "experiments/ds8_cumulative_semantic_credit_probe_handoff.md",
        ),
        (
            "DS8_DEFINITIVE_PROBE_V1_RESULT_SHA256",
            "results/ds8_cumulative_semantic_credit_probe_v1_negative.md",
        ),
        (
            "DS8_DEFINITIVE_PROBE_V1_AUDIT_SHA256",
            "experiments/ds8_cumulative_semantic_credit_probe_v1_negative_audit.md",
        ),
        (
            "DS8_DEFINITIVE_MICRO_PROTOCOL_SHA256",
            "experiments/ds8_cumulative_semantic_credit_micro_protocol.md",
        ),
        (
            "DS8_DEFINITIVE_MICRO_PROTOCOL_V2_SHA256",
            "experiments/ds8_cumulative_semantic_credit_micro_protocol_v2.md",
        ),
        (
            "DS8_DEFINITIVE_MICRO_SOURCE_SHA256",
            "src/ds8_cumulative_semantic_credit_micro.rs",
        ),
        (
            "DS8_DEFINITIVE_MICRO_RUNNER_SHA256",
            "src/bin/ds8_cumulative_semantic_credit_micro.rs",
        ),
        (
            "DS8_DEFINITIVE_MICRO_RESULT_SHA256",
            "results/ds8_cumulative_semantic_credit_micro_v2.md",
        ),
        (
            "DS8_DEFINITIVE_MICRO_AUDIT_SHA256",
            "experiments/ds8_cumulative_semantic_credit_micro_v2_result_audit.md",
        ),
        (
            "DS8_DEFINITIVE_DEVELOPMENT_HANDOFF_SHA256",
            "experiments/ds8_cumulative_semantic_credit_development_handoff.md",
        ),
        (
            "DS8_DEFINITIVE_MICRO_V1_RESULT_SHA256",
            "results/ds8_cumulative_semantic_credit_micro_v1_negative.md",
        ),
        (
            "DS8_DEFINITIVE_MICRO_V1_AUDIT_SHA256",
            "experiments/ds8_cumulative_semantic_credit_micro_v1_negative_audit.md",
        ),
        (
            "DS8_DEFINITIVE_GATE_PROTOCOL_SHA256",
            "experiments/ds8_cumulative_semantic_credit_gate_protocol.md",
        ),
        (
            "DS8_DEFINITIVE_GATE_PROTOCOL_V2_SHA256",
            "experiments/ds8_cumulative_semantic_credit_gate_protocol_v2.md",
        ),
        (
            "DS8_DEFINITIVE_GATE_PROTOCOL_V3_SHA256",
            "experiments/ds8_cumulative_semantic_credit_gate_protocol_v3.md",
        ),
        (
            "DS8_DEFINITIVE_GATE_SOURCE_SHA256",
            "src/ds8_cumulative_semantic_credit_gate.rs",
        ),
        (
            "DS8_DEFINITIVE_GATE_RUNNER_SHA256",
            "src/bin/ds8_cumulative_semantic_credit_gate.rs",
        ),
        (
            "DS8_DEFINITIVE_GATE_RESULT_SHA256",
            "results/ds8_cumulative_semantic_credit_gate_v3.md",
        ),
        (
            "DS8_DEFINITIVE_GATE_AUDIT_SHA256",
            "experiments/ds8_cumulative_semantic_credit_gate_v3_result_audit.md",
        ),
        (
            "DS8_DEFINITIVE_GATE_V1_RESULT_SHA256",
            "results/ds8_cumulative_semantic_credit_gate_v1_negative.md",
        ),
        (
            "DS8_DEFINITIVE_GATE_V1_AUDIT_SHA256",
            "experiments/ds8_cumulative_semantic_credit_gate_v1_negative_audit.md",
        ),
        (
            "DS8_DEFINITIVE_GATE_V2_RESULT_SHA256",
            "results/ds8_cumulative_semantic_credit_gate_v2_negative.md",
        ),
        (
            "DS8_DEFINITIVE_GATE_V2_AUDIT_SHA256",
            "experiments/ds8_cumulative_semantic_credit_gate_v2_negative_audit.md",
        ),
        (
            "DS8_DEFINITIVE_READINESS_SHA256",
            "experiments/ds8_cumulative_semantic_credit_definitive_readiness_handoff.md",
        ),
        (
        ...
        (
            "POST_M6_DS4_PROBE_RETRY_RESULT_SHA256",
            "results/post_m6_ds4_arrival_initiation_probe_retry.md",
        ),
        (
