...
const PROTOCOL: &str = "px5-physical-plasticity-allocation-gate-v2";
const PROTOCOL_COMMIT: &str = "5b4c6ce";
...
const BASE_NAMESPACE: u64 = 0x5_8000_0000;
const CELL_STRIDE: u64 = 0x0100_0000;
const CELLS: usize = 12;
const RESULT_CSV: &str = "results/px5_physical_plasticity_allocation_gate_v2.csv";
const RESULT_MD: &str = "results/px5_physical_plasticity_allocation_gate_v2.md";
...
fn run_cell(index: usize) -> CellResult {
        ...
        .enumerate()
    {
        run_start_return(
            ...
            &recurrent_useful,
            tick,
            namespace + 0xc0000 + cycle as u64 * 0x1000,
            reversed_insertion,
            &mut naturally_quiescent,
            &mut work,
            &mut ignored_updates,
