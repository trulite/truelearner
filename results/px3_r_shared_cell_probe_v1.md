...
| clause | result |
|---|:---:|
| frozen start, parent, source, and negative hashes exact | true |
| individual-route strength and activity marginals matched | false |
| trained structures execute and crossed structures do not | false |
| old structures weaken and swapped structures relearn | false |
| harder controls, replay, source, and quiescence | false |
| forbidden-information audit | true |
| positive development candidate | false |
