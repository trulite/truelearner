...
- Classification: **PROBE — B-only absorbing credit state; paired mature map pending**
...
- H=16: boundary live `[4, 4]`, M6 eligible `[true, false]`, margins `[16,0]`; E0@10000 live `[4, 1]`, B obs `10000`, B M5 `+0/-3`, abstentions `10000`, edge `credit edge`, reversed `false`; E1 first reversal `Some(1024)`, final live `[1, 4]`, A/B evidence `[414,19602]`
- H=32: boundary live `[4, 4]`, M6 eligible `[true, false]`, margins `[32,0]`; E0@10000 live `[4, 1]`, B obs `10000`, B M5 `+0/-3`, abstentions `10000`, edge `credit edge`, reversed `false`; E1 first reversal `Some(1024)`, final live `[1, 4]`, A/B evidence `[870,19162]`
