...
const RUNTIME_SHA: &str = "e6767845f27ddb9bb57bfb1fcab6dd1663178449faddc4a630b628e3d1148a8d";
...
const AUTHORITY_CASES: [Case; 16] = [
    ...
    Case::new(4_100_002, false, false, 1_170),
    Case::new(4_100_003, false, false, 1_300),
    Case::new(4_100_004, false, false, 1_430),
    Case::new(4_100_005, true, false, 1_040),
    Case::new(4_100_006, true, false, 1_170),
    Case::new(4_100_007, true, false, 1_300),
    Case::new(4_100_008, true, false, 1_430),
    Case::new(4_100_009, false, true, 1_040),
    Case::new(4_100_010, false, true, 1_170),
    Case::new(4_100_011, false, true, 1_300),
    Case::new(4_100_012, false, true, 1_430),
    Case::new(4_100_013, true, true, 1_040),
    Case::new(4_100_014, true, true, 1_170),
    Case::new(4_100_015, true, true, 1_300),
    Case::new(4_100_016, true, true, 1_430),
];
...
impl Mode {
    ...
    fn csv(self) -> &'static str {
        assert_eq!(self, Self::Authority);
        "experiments/results/physical_body_v1_authority.csv"
    }

    fn report(self) -> &'static str {
        assert_eq!(self, Self::Authority);
        "experiments/results/physical_body_v1_authority.md"
    }

    fn marker(self) -> &'static str {
        match self {
            Self::Preflight => "PHYSICAL_BODY_V1_AUTHORITY_PREFLIGHT_READY",
            Self::Authority => "PHYSICAL_BODY_V1_AUTHORITY_EVIDENCE_SPENT",
        }
    }

    fn title(self) -> &'static str {
        assert_eq!(self, Self::Authority);
        "Physical Body V1 successor authority"
    }
}
...
fn main() {
    ...
    publish(mode.report(), &markdown(mode, &rows, globals, &body));
    ...
    println!("PHYSICAL_BODY_V1_AUTHORITY_ESTABLISHED rows=16/16 clauses=540/540");
}
...
fn markdown(
    ...
    writeln!(
        text,
        "Outcome: **{}**.\n",
        if passed_rows == 16 && global_clauses == 12 && body_clauses == 16 {
    ...
    writeln!(
        text,
        "- total clauses: `{}/540`;",
        row_clauses + global_clauses + body_clauses
    )
    .unwrap();
    writeln!(
        text,
