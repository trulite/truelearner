...
fn main() {
    ...
    println!(
        "R6_PARTITION_INVARIANCE_AH0_SUCCESSOR_PASS worlds={} comparisons={comparisons} checkpoint_controls=2/2 clauses={clauses}/{clauses} output={}",
        worlds.len(),
        output.display()
    );
}
...
fn output_directory() -> PathBuf {
    ...
    match (args.next(), args.next(), args.next()) {
        ...
        (None, None, None) => PathBuf::from("results/r6_partition_invariance_ah0_v1"),
