use px3_r_trace_coupling::arm::{
    acquisition_work, add_work, advance, drive, drive_nearby, fresh, state, use_at, Counts, State,
    LANES,
};
use px3_r_trace_coupling::{LocalActivityOpportunity, WorkLedger};
use std::env;
...
const ARM_LAW_SHA256: &str = "caac29fd6748725e08323b6426f53011ffa16e639165c05c3517519202037845";
const ARM_WORLD_SHA256: &str = "544d1585af2efa004f7b9d0248df1be4d1f35ced14ecc0a329101d727e2dc875";
const PROTOCOL_SHA256: &str = "453e62864327d1a022ef346bd573547120c72f344d821cb066126bce1957e089";
const GENERIC_RESULT_SHA256: &str =
    "012c591f7b1e63c7d8902dab71b540a6a9235ae19910907a647aecbbaa81070e";
const PROTOCOL: &str = "experiments/px3_r_direct_trace_coupling_probe_v3_protocol.md";
const RESULT_CSV: &str = "results/px3_r_direct_trace_coupling_probe_v1.csv";
const RESULT_MD: &str = "results/px3_r_direct_trace_coupling_probe_v1.md";
const STAGING_CSV: &str = "results/.px3_r_direct_trace_coupling_probe_v1.csv.staging";
const STAGING_MD: &str = "results/.px3_r_direct_trace_coupling_probe_v1.md.staging";
const RECURRENCES: usize = 12;
const FIRST_TICK: i64 = 66;
...
fn main() {
    ...
    if preflight {
        println!("PX3_R_DIRECT_TRACE_COUPLING_PROBE_V1_PREFLIGHT_OK");
        return;
    }
    eprintln!("PX3_R_DIRECT_TRACE_COUPLING_PROBE_V1_EVIDENCE_SPENT");
    let report = run_probe();
    write_atomic(&report);
    println!(
        "PX3_R_DIRECT_TRACE_COUPLING_PROBE_V1_{}",
...
fn run_probe() -> Report {
    let mut positive = run_positive("positive", 0xa_3100_0000);
    let duplicate = run_positive("positive", 0xa_3100_0000);
...
fn source_audit() -> bool {
    let hashes = [
        ...
        ("arms/px3-r-trace-coupling/src/lib.rs", ARM_LAW_SHA256),
        ("arms/px3-r-trace-coupling/src/arm.rs", ARM_WORLD_SHA256),
        (PROTOCOL, PROTOCOL_SHA256),
        (
            "results/px3_r_trace_coupling_generic_opportunity_probe_v2.csv",
            GENERIC_RESULT_SHA256,
        ),
    ];
